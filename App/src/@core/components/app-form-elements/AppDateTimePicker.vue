        ...
        <VField v-bind="{ ...fieldProps, label: undefined }" :id="id.value" role="textbox"
          ...
          <template #default="{ props: vFieldProps }">
            <div v-bind="vFieldProps">
              <!-- flat-picker  -->
              <FlatPickr v-if="!isInlinePicker" v-bind="compAttrs" :id="elementId" ref="refFlatPicker"
                :model-value="modelValue" :placeholder="props.placeholder" class="flat-picker-custom-style"
              ...
              <input v-if="isInlinePicker" :value="modelValue" :placeholder="props.placeholder"
                class="flat-picker-custom-style" type="text">
            </div>
          </template>
        </VField>
      </template>
